    ...
    <div class="bg-white dark:bg-card-dark border border-gray-200 dark:border-border-dark rounded-xl p-4 shadow-sm hover:shadow-md transition-all hover:border-primary/30 dark:hover:border-primary/50">
      ...
      <div class="flex justify-between items-start mb-4">
        ...
        <div class="flex items-center gap-2">
          ...
          <button
            ...
            class="p-1.5 text-slate-400 dark:text-text-dim hover:text-red-500 transition-colors rounded-md hover:bg-red-50 dark:hover:bg-red-900/20 focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:ring-offset-2 outline-none"
      ...
      {rl && (
        <div class="pt-3 mt-3 border-t border-slate-100 dark:border-border-dark">
          ...
          {pct != null && (
            <div
              class="w-full bg-slate-100 dark:bg-border-dark rounded-full h-2 overflow-hidden"
              role="progressbar"
              aria-valuenow={pct}
              aria-valuemin={0}
              aria-valuemax={100}
